...
<table cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    ...
    <br />
    <b><div class="prtitle">LAPORAN PENJUALAN</div></b>
   ...
   <div class="">
    <table align="center" width="700" class="uiTableList" cellpadding="5" cellspacing="0" border="0">
     <tbody style="font-family: Times New Roman">
        <?php 
          $sql = "SELECT * FROM view_transaksi_penjualan WHERE id_penjualan = '".$_GET['id_penjualan']."'";
...
<!--       <tr>  
        <td width="75">Pelanggan</td>
        <td width="10" align="center">:</td>
        <td width="300"><?php //echo $hasil['nama_pelanggan']; ?></td>
      </tr> -->
        <?php 
          }
         ?>
    ...
    <tbody style="font-family: Times New Roman;text-align: justify;">
      ...
      <?php 
        $total = 0;
        $sql = "SELECT * FROM view_detail_transaksi_penjualan WHERE id_penjualan = '".$_GET['id_penjualan']."'";
        $result = $conn->query($sql);
        while ($hasil = $result->fetch_assoc()) {
      ?>
        <tr>
          ...
          <?php $total = $total + ($hasil['jumlah'] * $hasil['harga_jual']); ?>
          <td><?php echo $hasil['jumlah'] * $hasil['harga_jual']; ?></td>
        </tr>
        <?php $i = $i + 1; ?>
      <?php } ?>
        <tr>
    ...
    <tbody style="font-family: Times New Roman;">
      ...
      <tr>
        <td width="500"></td>
        <td width="200">Semarang, <?php echo date_format(date_create($hasil['tanggal_penjualan']), "d F Y"); ?></td>
      </tr>
      <tr>
        <td width="500"></td>
